      ...
      <div className="app">
        ...
        <div className="w-[688px] h-screen flex flex-wrap pt-16 gap-16">
          ...
          <div className="flex-col justify-start items-center gap-6 inline-flex w-full">
            ...
            <div className="w-full text-left mb-12">
              ...
              <ParagraphToImageConversion className="text-[#344054] text-lg font-normal font-['Inter'] leading-7">
                ...
                smart Deployment strategies ensure your bot can scale
                effectively. Together, these features create engaging and
                efficient conversational agents.
              ...
              <div className="mt-6 border-l-4 border-[#000000] pl-4 py-2">
                ...
                <ParagraphToImageConversion className="text-[#344054] text-lg font-normal font-['Inter'] leading-7">
                  ...
                  confidently understand what the user is trying to say. Setting
                  this to 0.4 means that your chatbot needs to be at least 40%
                  confident that it understands what the user is asking to be
                  able to give a response. So if a user's input is ambiguous and
                  your chatbot's confidence score is below 0.4, it'll throw an
                  error message. You'll see how this works in a bit!
                </ParagraphToImageConversion>
              </div>
            </div>
          ...
          <div className="text-[#344054] text-lg font-normal font-['Inter'] leading-7 text-left">
            ...
            show your problem solving skills! Keep this slide in mind if you
            ever run into an error, and make sure to add in some screenshots and
