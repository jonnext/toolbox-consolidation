        ...
        <div className="app">
          ...
          <div className="w-[688px] h-screen flex flex-wrap pt-16 gap-16">
            ...
            <div className="h-[378px] flex-col justify-start items-center gap-6 inline-flex">
              <h2 className="text-left self-stretch text-[#101828] text-3xl font-semibold font-suisse leading-[38px]">
                ⚡️ 30 second Summary
              </h2>
              <div className="text-left self-stretch text-[#101828] text-lg font-normal font-['Inter'] leading-7">
                ...
                project is going to supercharge your skills in Amazon Lex and
                AWS Lambda, giving you the power to build something interactive
                and practical.
                <br />
                Amazon Lex is a tool that helps you create programs that can
                talk or chat with people, just like Siri or Alexa. It
                understands what people say or type and helps the program
                ...
                about their bank balances and transactions. You can even
                converse with your BankerBot using voice commands!
              </div>
            </div>
            <div className="flex-col justify-start items-center gap-6 inline-flex w-full">
              ...
              <div className="w-full text-left mb-12">
                ...
                <ParagraphToImageConversion className="text-[#344054] text-lg font-normal font-['Inter'] leading-7">
                  ...
                  interactions. It uses Natural Language Processing to
                  understand what users say, while Intent Recognition identifies
                  their needs. Slot Filling keeps conversations flowing
                  smoothly, and Voice Interaction lets users chat using their
                  voice with AWS Polly. Plus, Analytics tracks interactions to
                  boost performance, and smart Deployment strategies ensure your
                  bot can scale effectively. Together, these features create
                  engaging and efficient conversational agents.
                ...
                <div className="mt-6 border-l-4 border-[#000000] pl-4 py-2">
                  <h4 className="text-[#101828] text-lg font-medium font-['Inter'] leading-7 mb-2">
                    💡 What does intent classification confidence score
                    threshold mean?
                  </h4>
                  <ParagraphToImageConversion className="text-[#344054] text-lg font-normal font-['Inter'] leading-7">
                    When you're using Amazon Lex to build a chatbot, this
                    threshold is like a minimum score for your chatbot to
                    confidently understand what the user is trying to say.
                    Setting this to 0.4 means that your chatbot needs to be at
                    least 40% confident that it understands what the user is
                    asking to be able to give a response. So if a user's input
                    is ambiguous and your chatbot's confidence score is below
                    0.4, it'll throw an error message. You'll see how this works
                    in a bit!
                  </ParagraphToImageConversion>
                </div>
              </div>
              ...
              <div className="text-left self-stretch text-[#101828] text-lg font-normal font-['Inter'] leading-7 mt-4">
                How much support and guidance do you want? There are two ✌️
                equally awesome ways to can complete your project.
              </div>
            </div>
            ...
            <div className="text-[#344054] text-lg font-normal font-['Inter'] leading-7 text-left">
              ...
              <br />• Check out the final slide, which is a template for
              tracking errors - keep in mind that documenting errors is a
              fantastic way to show your problem solving skills! Keep this slide
              in mind if you ever run into an error, and make sure to add in
              some screenshots and explanations as you go.
            </div>
          </div>
          <BottomBar />
        </div>
